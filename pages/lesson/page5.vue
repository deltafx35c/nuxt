<template>
  <section class="container">
    ...
    <p>
      ...
      在上述的例子中，我们需要一个模块打包器，找到所有 require 语句（它在浏览器端的 JavaScript 中是非法的）并把它们替换成想要 require 的文件的实际的内容。
    ...
    <p>
      刷新一下浏览器，我们熟悉index.html又回来了。这一次，我们的页面已经是经过工程化加工过的高级货了。
    </p>
    <p>
    ...
    <p>
      ...
      使用配置文件比手动输入各种参数要好了一点，但每次修改代码还要敲命令启动还是很麻烦 ： 之后我们会想办法解决这个问题。
    </p>
    <p>
